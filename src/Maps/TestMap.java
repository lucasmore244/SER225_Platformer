...
public class TestMap extends Map {
	...
	public ArrayList<EnhancedMapTile> loadEnhancedMapTiles() {
		...
		enhancedMapTiles.add(new HorizontalMovingPlatform(ImageLoader.load("GreenPlatform.png"),
				getMapTile(36, 8).getLocation(), getMapTile(43, 8).getLocation(), TileType.JUMP_THROUGH_PLATFORM, 3,
				new Rectangle(0, 6, 16, 4), Direction.LEFT));
		enhancedMapTiles.add(new HorizontalMovingPlatform(ImageLoader.load("GreenPlatform.png"),
				getMapTile(41, 8).getLocation(), getMapTile(51, 8).getLocation(), TileType.JUMP_THROUGH_PLATFORM, 3,
				new Rectangle(0, 6, 16, 4), Direction.RIGHT));
		enhancedMapTiles.add(new HorizontalMovingPlatform(ImageLoader.load("GreenPlatform.png"),
	...
	public ArrayList<NPC> loadNPCs() {
		...
		npcs.add(new Walrus(getMapTile(4, 11).getLocation().subtractY(13), 1));
		npcs.add(new Walrus(getMapTile(30, 10).getLocation().subtractY(13), 2));
		return npcs;
	}
