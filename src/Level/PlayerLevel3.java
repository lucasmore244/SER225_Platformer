...
public abstract class PlayerLevel3 extends GameObject {
	...
	public PlayerLevel3(SpriteSheet spriteSheet, float x, float y, String startingAnimationName) {
	...
	protected void handlePlayerAnimation() {
		if (playerState == PlayerState.STANDING) {
			...
			/*
			 * else if (playerState == PlayerState.TAKING_DAMAGE) { if (previousPlayerState
			 * == PlayerState.STANDING) { System.out.println(playerState);
			 * this.currentAnimationName = facingDirection == Direction.RIGHT ?
			 * "STAND_RIGHT_RED" : "STAND_LEFT_RED";
			 * 
			 * } else if (previousPlayerState == PlayerState.WALKING) {
			 * System.out.println(playerState); this.currentAnimationName = facingDirection
			 * == Direction.RIGHT ? "WALK_RIGHT_RED" : "WALK_LEFT_RED";
			 * 
			 * } previousPlayerState = playerState; super.update();
			 * 
			 * }
			 */
		}
